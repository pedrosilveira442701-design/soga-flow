    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          liquid: "hsl(var(--brand-liquid))",
          cost: "hsl(var(--brand-cost))",
          danger: "hsl(var(--brand-danger))",
          warn: "hsl(var(--brand-warn))",
          ink: "hsl(var(--brand-ink))",
          surface: "hsl(var(--brand-surface))",
          gray: {
            900: "hsl(var(--brand-ink))",
            600: "hsl(var(--brand-cost))",
            400: "hsl(220 9% 68%)",
            200: "hsl(220 13% 91%)",
            50: "hsl(220 14% 96%)",
          },
