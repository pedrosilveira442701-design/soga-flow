-- Add data_fechamento column to propostas table
ALTER TABLE public.propostas 
ADD COLUMN data_fechamento timestamp with time zone;

-- Drop dependent view first
DROP VIEW IF EXISTS public.vw_insights_pool;

-- Drop and recreate vw_propostas to use data_fechamento when available
...
-- Recreate vw_insights_pool with all sources
