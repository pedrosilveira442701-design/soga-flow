// src/components/anotacoes/AnotacaoDrawer.tsx
      ...
      <SheetContent className="sm:max-w-[600px] overflow-y-auto">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="title" placeholder="Ex: Ligar para João..." {...form.register("title")} />
          ...
          <div className="space-y-2">
            ...
            <Textarea id="note" placeholder="Detalhes adicionais..." rows={4} {...form.register("note")} />
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            {!selectedClientId && (
              <Input placeholder="Ou digite o nome do cliente..." {...form.register("client_name")} />
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="tags" placeholder="orçamento, urgente, cliente-vip" {...form.register("tags")} />
          </div>
